...
const columns = (generatePDF: (id: string) => void) => [
  {
    title: 'Reuniones',
    dataIndex: 'reuniones',
    key: 'reuniones',
  ...
  },
  {
    ...
    render: (text: string, record: any) => (
      <Button 
        type='primary' 
        onClick={() => generatePDF(record.key)} // Llama a la función generatePDF con el ID
      >
    PDF
      </Button>
    ),
...
.formatted-text {
 ...
 @page {
  ...
  return (
    <Table columns={columns(generatePDF)} dataSource={dataSource} />
  );
};
